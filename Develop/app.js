...
const fullTeam=[];
 ...
 function createManager(){
    ...
    function crew(){
        const promptQuestions=[
              {
                  ...
                  choices:[
                      "Engineer",
                      "Intern",
                      "I dont want to add anymore members to my team",
                  ]
              } 
            ];inquirer.prompt(promptQuestions).then(function(data){
                if (data.crewSelection ==="Engineer"){
                    engineer();
                }
                else if (data.crewSelection === "Intern"){
                    intern();
                }
                else (endTeam());
            })
        ...
        function engineer(){
            console.log("Please enter the Engineers information")
            inquirer.prompt([
              {
                  type:"input",
                  name:"engineersName",
        ...
        function intern(){
            console.log("please enter the Interns Information")
            inquirer.prompt([
                {
                    type:"input",
                    name:"internsName",
